      ...
      >
        ...
        <Form isHorizontal>
          ...
          <FormGroup
            ...
            error={credentialNameError ? 'error' : null}
            helperText={credentialNameError && <Form.HelpBlock>{credentialNameError}</Form.HelpBlock>}
          >
            <TextInput
              type="text"
              className="quipucords-form-control"
          ...
          <FormGroup
            label="Username"
            error={usernameError ? 'error' : null}
            helperText={usernameError && <Form.HelpBlock>{usernameError}</Form.HelpBlock>}
          >
            <TextInput
              type="text"
